...
const COURSES = [
  { provider: "Highfield Qualifications", title: "Level 2 Award in Cleaning Principles", type: "Accredited", location: "Various UK locations", format: "Face-to-face", duration: "1 day", price: "£120-£180", url: "https://www.highfieldqualifications.com", accreditation: "Ofqual regulated" },
  { provider: "BICS", title: "Professional Cleaning Operator", type: "Industry Accredited", location: "London & nationwide", format: "Face-to-face + online", duration: "2 days", price: "£195-£250", url: "https://www.bics.org.uk", accreditation: "BICS accredited" },
  { provider: "Trained Up", title: "COSHH Awareness for Cleaners", type: "Specialist", location: "Online + London venues", format: "Online or face-to-face", duration: "Half day", price: "£65-£95", url: "https://www.highfieldqualifications.com/cleaning", accreditation: "CPD certified" },
  { provider: "Direct Learning", title: "Manual Handling for Cleaning Staff", type: "Essential", location: "East London / City", format: "Face-to-face", duration: "Half day", price: "£45-£75", url: "https://www.hse.gov.uk/manual-handling/training.htm", accreditation: "CPD certified" },
  { provider: "City & Guilds", title: "Level 1 Award in Cleaning Skills", type: "Nationally Recognised", location: "Colleges nationwide", format: "Face-to-face", duration: "2-4 weeks", price: "Funded options available", url: "https://www.cityandguilds.com", accreditation: "City & Guilds" },
  { provider: "St John Ambulance", title: "First Aid at Work", type: "Regulated", location: "London venues", format: "Face-to-face", duration: "3 days", price: "£250-£350", url: "https://www.sja.org.uk", accreditation: "HSE approved" },
  { provider: "NCFE", title: "Level 2 Certificate in Infection Prevention", type: "Accredited", location: "Online + supported learning", format: "Blended learning", duration: "6-8 weeks", price: "£150-£200", url: "https://www.ncfe.org.uk", accreditation: "Ofqual regulated" },
  { provider: "Skills for Care", title: "Infection Prevention and Control", type: "Specialist", location: "Online", format: "Online self-paced", duration: "3 hours", price: "£25-£40", url: "https://www.skillsforcare.org.uk", accreditation: "CPD certified" },
];
