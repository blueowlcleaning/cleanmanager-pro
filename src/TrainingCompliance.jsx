...
const COURSES = [
  ...
  { provider: "Trained Up", title: "COSHH Awareness for Cleaners", type: "Specialist", location: "Online + London venues", format: "Online or face-to-face", duration: "Half day", price: "£65-£95", url: "https://www.trainedupacademy.com", accreditation: "CPD certified" },
  { provider: "Direct Learning", title: "Manual Handling for Cleaning Staff", type: "Essential", location: "East London / City", format: "Face-to-face", duration: "Half day", price: "£45-£75", url: "https://www.directlearning.co.uk", accreditation: "CPD certified" },
